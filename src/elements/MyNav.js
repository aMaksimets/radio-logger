            ...
            <Drawer anchor='left' open={drawerOpen} onClose={() => toggleDrawer()}>
              <div className={classes.list}>
                <List>
                  ...
                  <Collapse in={leadershipTriadMenuOpen} timeout='auto' unmountOnExit>
                    <List component='div' disablePadding>
                      <ListItem button component={Link} to='/swllog' className={classes.nested}>
                        <ListItemIcon>
                          <FolderIcon />
                        </ListItemIcon>
                    ...
                    <List component='div' disablePadding>
                      <ListItem button component={Link} to='/design' className={classes.nested}>
                        <ListItemIcon>
                          <FolderIcon />
                        </ListItemIcon>
                    ...
                    <List component='div' disablePadding>
                      <ListItem button component={Link} to='/scanlog' className={classes.nested}>
                        <ListItemIcon>
                          <FolderIcon />
                        </ListItemIcon>
                    ...
                    <List component='div' disablePadding>
                      <ListItem button component={Link} to='/mwlog' className={classes.nested}>
                        <ListItemIcon>
                          <FolderIcon />
                        </ListItemIcon>
